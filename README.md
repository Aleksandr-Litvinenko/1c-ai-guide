...
Практический open-source гид по применению AI в экосистеме 1С:Предприятия: Agent Skills, MCP, OData, интеграции, безопасность и проверяемые сценарии.
...
> Цель гида — помочь выбрать минимальный безопасный стек под задачу. Это не рейтинг и не знак сертификации: перед использованием проверяйте исходный код, лицензию и модель доступа каждого проекта.
...
Начните с [рецепта разработки](recipes/ai-assisted-development.md). Базовая связка:
...
Начните с [рецепта Bitrix24](recipes/bitrix24-assistant.md). Разделяйте два слоя:
